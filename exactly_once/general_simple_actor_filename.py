...
def exactly_once_init(exactly_once):
	filename = "constructor_" + str(np.random.rand()) + ".txt"
	print(filename)
...
def exactly_once_method():
	filename = "method_" + str(np.random.rand()) + ".txt"
	print(filename)
...
class Server(object):
	@exactly_once_init(exactly_once=True)
...
if __name__ == "__main__":
	...
	fileList = glob.glob('/Users/accheng/Documents/ray_notebooks/exactly_once/*.txt', recursive=True)
